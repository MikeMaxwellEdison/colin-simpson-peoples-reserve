# Colin Simpson — The People’s Reserve

A private family-made Father’s Day collection published as a carefully curated public page.

The permanent address is:

https://mikemaxwelledison.github.io/colin-simpson-peoples-reserve/

## Quick caption updates

The details still being confirmed by family are kept together in `editable-details.js`.
Edit only the wording between the quotation marks for the matching item. The updated wording
will appear everywhere that caption is used, while the permanent website address and QR code
remain unchanged.

The editable details cover the early family portrait, Waikanae trophy, All Blacks match,
